...
-- Copy and paste this entire script into the SQL Editor at https://supabase.com/dashboard/project/vmnutxcgbfomkrscwgcy/sql
...
-- Drop existing policies to avoid conflicts
DROP POLICY IF EXISTS "Authenticated users can vote on images" ON public.image_votes;
DROP POLICY IF EXISTS "Users can update their own votes" ON public.image_votes;
DROP POLICY IF EXISTS "Users can delete their own votes" ON public.image_votes;
DROP POLICY IF EXISTS "Public can view vote counts" ON public.image_votes;
