  ...
  >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="description">
          Help us maintain quality by reporting hazards that violate our
          community guidelines. All flags are reviewed by moderators.
        </p>
        ...
        <div class="info-box">
          <p>
            <strong>Note:</strong> False flags may negatively impact your trust score.
          </p>
        </div>
      </div>
