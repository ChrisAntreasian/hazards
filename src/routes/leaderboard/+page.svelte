...
<svelte:head>
  ...
  <meta
    name="description"
    content="Top contributors to the Hazards community ranked by trust score"
  />
</svelte:head>
...
<div class="leaderboard-page">
  ...
  <div class="leaderboard-container">
    ...
    <div class="info-footer">
      <p>
        Trust scores are earned through positive community contributions
        including reporting hazards, voting, confirming resolutions, and helping
        moderate content.
      </p>
    </div>
  </div>
