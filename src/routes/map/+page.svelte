...
<svelte:head>
	...
	<meta name="description" content="Interactive map showing reported hazards in your area. View real-time safety information and plan safer routes." />
</svelte:head>
...
<div class="map-page">
	<div class="map-header">
		...
		<p class="map-description">
			Interactive map showing {hazards.length} active hazards in your area. 
	...
	<div class="map-controls">
		<div class="map-stats">
			...
			<div class="stat-item">
				<span class="stat-number">{new Set(hazards.map(h => h.category_name)).size}</span>
	...
	<div class="map-container">
		<Map {hazards} height="600px" showUserLocation={true} />
	</div>

	<div class="map-footer">
		<p class="help-text">
			💡 <strong>Tip:</strong> Allow location access to center the map on your current position. 
			Click markers to see hazard details and report dates.
		</p>
		...
		<div class="action-buttons">
			...
			<a href="/my-reports" class="btn btn-secondary">
				📋 My Reports
			</a>
		</div>
	</div>
