<script lang="ts">
  ...
  function handleLocationFound(location: Location, zoom?: number) {
    if (mapInstance) {
      mapInstance.setView([location.lat, location.lng], zoom || 13, {
        animate: true,
      });
    }
  }
...
<div class="map-page">
  ...
  <div class="map-controls-panel">
    <MapLocationSearch
      ...
      placeholder="Search by address, city, zip code, or coordinates..."
...
<style>
  ...
  /* Layer controls and location search now handled by unified components */
